...
import { Camera, Video, Users, Award, Loader2 } from "lucide-react";
import { Card, CardContent } from "./ui/card";
import { useSiteContent, ServicesContent } from "@/hooks/useSiteContent";
...
export const Services = () => {
  const { content, isLoading } = useSiteContent<ServicesContent>('services');
    ...
    <section className="py-24 bg-gradient-to-b from-background to-mist">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {displayContent.items.map((service, index) => {
